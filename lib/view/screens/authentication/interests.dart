...
class Interests extends StatefulWidget {
  const Interests(
      ...
      required this.newWilaya});

  final String email, password, userName, phoneNbr, newWilaya;
              ...
              onTap: (){
                  ...
                  if (myListInterest.length > 4) {
                    ...
                    AuthController.instance.Register(
                        ...
                        widget.phoneNbr,
                        widget.newWilaya,
                        context,myListInterest);
                    //StoreController.instance.myInterest(myListInterest);
                  }
